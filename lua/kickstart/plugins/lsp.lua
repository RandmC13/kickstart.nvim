  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Opens a popup that displays information about the symbols under your cursor in insert mode
        vim.keymap.set({ 'i', 's' }, '<M-k>', vim.lsp.buf.signature_help, { desc = 'Show signature help' })
    ...
    -- require('mason').setup()
    -- Mason was setup by the opts = {} command
